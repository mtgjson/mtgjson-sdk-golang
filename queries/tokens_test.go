...
func TestTokenGetByUUID(t *testing.T) {
	...
	q := NewTokenQuery(conn)
	ctx := context.Background()

	token, err := q.GetByUUID(ctx, "token-uuid-001")
	if err != nil {
		t.Fatal(err)
	}
	if token == nil {
...
func TestTokenGetByUUIDNotFound(t *testing.T) {
	...
	token, err := q.GetByUUID(ctx, "nonexistent")
	if err != nil {
		t.Fatal(err)
	}
	if token != nil {
...
func TestTokenGetByName(t *testing.T) {
	...
	tokens, err := q.GetByName(ctx, "Soldier Token")
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 1 {
...
func TestTokenSearchByName(t *testing.T) {
	...
	tokens, err := q.Search(ctx, SearchTokensParams{Name: "%Token"})
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 2 {
...
func TestTokenSearchBySet(t *testing.T) {
	...
	tokens, err := q.Search(ctx, SearchTokensParams{SetCode: "A25"})
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 1 {
...
func TestTokenSearchByColors(t *testing.T) {
	...
	tokens, err := q.Search(ctx, SearchTokensParams{Colors: []string{"G"}})
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 1 {
...
func TestTokenCountFiltered(t *testing.T) {
	...
	count, err := q.Count(ctx, Filter{Column: "setCode", Value: "A25"})
	if err != nil {
		t.Fatal(err)
	}
	if count != 1 {
...
func TestTokenGetByUUIDs(t *testing.T) {
	...
	tokens, err := q.GetByUUIDs(ctx, []string{"token-uuid-001", "token-uuid-002"})
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 2 {
...
func TestTokenGetByUUIDsEmpty(t *testing.T) {
	...
	tokens, err := q.GetByUUIDs(ctx, []string{})
	if err != nil {
		t.Fatal(err)
	}
	if len(tokens) != 0 {
