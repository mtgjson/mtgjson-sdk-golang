...
func TestCardGetByUUID(t *testing.T) {
	...
	card, err := sdk.Cards().GetByUUID(ctx, "card-uuid-001")
	if err != nil {
		t.Fatal(err)
	}
	if card == nil {
...
func TestCardGetByUUIDNotFound(t *testing.T) {
	...
	card, err := sdk.Cards().GetByUUID(ctx, "nonexistent")
	if err != nil {
		t.Fatal(err)
	}
	if card != nil {
...
func TestCardSearchByNameLike(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Name: "Lightning%"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchByRarity(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Rarity: "uncommon"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 3 {
...
func TestCardSearchByManaValue(t *testing.T) {
	...
	mv := 1.0
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{ManaValue: &mv})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchByColors(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Colors: []string{"U"}})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchByText(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Text: "Counter target spell"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchWithLimit(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Limit: 1})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchLegalIn(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{LegalIn: "modern"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 2 {
...
func TestCardRandom(t *testing.T) {
	...
	cards, err := sdk.Cards().Random(ctx, 1)
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardFindByScryfallID(t *testing.T) {
	...
	cards, err := sdk.Cards().FindByScryfallID(ctx, "scryfall-001")
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchByArtist(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Artist: "Christopher Moeller"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchByArtistLike(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Artist: "Zack"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchByColorIdentity(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{ColorIdentity: []string{"R"}})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchByAvailability(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Availability: "paper"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 3 {
...
func TestCardSearchByLanguage(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Language: "English"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 3 {
...
func TestCardSearchByLayout(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Layout: "normal"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 2 {
...
func TestCardSearchByLayoutSplit(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{Layout: "split"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchBySetType(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{SetType: "masters"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 2 {
...
func TestCardSearchByManaValueRange(t *testing.T) {
	...
	gte := 1.0
	lte := 1.5
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{ManaValueGTE: &gte, ManaValueLTE: &lte})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardGetAtomicByFaceName(t *testing.T) {
	...
	result, err := sdk.Cards().GetAtomic(ctx, "Fire")
	if err != nil {
		t.Fatal(err)
	}
	if len(result) < 1 {
...
func TestCardGetAtomicNotFound(t *testing.T) {
	...
	result, err := sdk.Cards().GetAtomic(ctx, "Nonexistent Card Face")
	if err != nil {
		t.Fatal(err)
	}
	if len(result) != 0 {
...
func TestCardGetByUUIDs(t *testing.T) {
	...
	cards, err := sdk.Cards().GetByUUIDs(ctx, []string{"card-uuid-001", "card-uuid-002"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 2 {
...
func TestCardGetByUUIDsNonexistent(t *testing.T) {
	...
	cards, err := sdk.Cards().GetByUUIDs(ctx, []string{"no-such-uuid"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 0 {
...
func TestCardGetByUUIDsPartialMatch(t *testing.T) {
	...
	cards, err := sdk.Cards().GetByUUIDs(ctx, []string{"card-uuid-001", "no-such-uuid"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchLocalizedNameExact(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{LocalizedName: "Blitzschlag"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchLocalizedNameLike(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{LocalizedName: "Blitz%"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchLocalizedNameNotFound(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{LocalizedName: "Nonexistent"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 0 {
...
func TestCardSearchLocalizedNameFrench(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{LocalizedName: "Foudre"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 1 {
...
func TestCardSearchTextRegex(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{TextRegex: "deals \\d+ damage"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchTextRegexNoMatch(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{TextRegex: "^This card does nothing$"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 0 {
...
func TestCardSearchFuzzyName(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{FuzzyName: "Ligtning Bolt"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchFuzzyNameExact(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{FuzzyName: "Lightning Bolt"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
...
func TestCardSearchFuzzyNameNoMatch(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{FuzzyName: "zzzzzzzzzzzzz"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) != 0 {
...
func TestCardSearchFuzzyNameOrderedBySimilarity(t *testing.T) {
	...
	cards, err := sdk.Cards().Search(ctx, SearchCardsParams{FuzzyName: "Countrsepll"})
	if err != nil {
		t.Fatal(err)
	}
	if len(cards) < 1 {
