...
func newIdentifierQuery(conn *Connection) *IdentifierQuery {
...
func (q *IdentifierQuery) findBy(ctx context.Context, idColumn, value string) ([]CardSet, error) {
...
func (q *IdentifierQuery) FindBy(ctx context.Context, idType, value string) ([]CardSet, error) {
